# Responsibilities:
# - Converts a human-readable address into geographic coordinates (latitude, longitude) and postal code using the Google Maps Geocoding API.
...
#
# Note: API key is expected to be set in ENV['GOOGLE_MAPS_API_KEY'].
